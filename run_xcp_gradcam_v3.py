...
class GradCAM:
    ...
    def _backward_hook(self, m, i, o):
        self.gradients = o[0].detach().clone()
...
xcp.load_state_dict(torch.load(os.path.expanduser('~/checkpoints/xceptionnet_best.pth'), map_location='cpu'))
xcp = xcp.eval()

# Use block2 last conv as target layer instead
